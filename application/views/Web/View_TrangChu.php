                	...
                	<nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
							<ul class="navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a class="nav-link" href="<?php echo base_url('san-pham/'); ?>" style="font-family: system-ui;"><i class="linearicons-layers"></i> Chuyên Mục</a>   
                                </li>
                                <li><a class="nav-link nav_item" href="contact.html" style="font-family: system-ui;"><i class="linearicons-news"></i> Tin Tức</a></li> 
                                <li><a class="nav-link nav_item" href="contact.html" style="font-family: system-ui;"><i class="linearicons-phone-wave"></i> Liên Hệ</a></li> 
                            </ul>
                        </div>
        ...
        <div class="custom-container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                	<div class="widget">
                        <div class="footer_logo">
                            <a href="#"><img style="width: 182px; height: 47px;" src="<?php echo $config[0]['Logo']; ?>" alt="logo"/></a>
                        </div>
                        <p class="mb-3"><?php echo $config[0]['MoTaWeb']; ?></p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                	<div class="widget">
                        <h6 class="widget_title">Hình Ảnh</h6>
                        <ul class="widget_instafeed instafeed_col4">
                            <?php foreach ($image as $key => $value): ?>
                                <li>
                                    <a href="<?php echo base_url('san-pham/'.$value['DuongDan'].'/'); ?>">
                                        <img style="width: 128px; height: 128px;" src="<?php echo explode('#', $value['HinhAnh'])[0]; ?>"><span class="insta_icon"><i class="ti-instagram"></i></span>
                                    </a>
                                </li>
                            <?php endforeach ?>
                            <li></li>
